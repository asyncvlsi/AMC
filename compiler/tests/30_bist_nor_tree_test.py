...
class bist_nor_tree_test(AMC_test):
    ...
    def runTest(self):
        ...
        a = nor_tree.nor_tree(size=3, name="nor_tree_2")
        self.local_check(a)

        debug.info(1, "Testing 3 input nor_tree")
        a = nor_tree.nor_tree(size=4, name="nor_tree_3")
        self.local_check(a)

        debug.info(1, "Testing 7 input nor_tree")
