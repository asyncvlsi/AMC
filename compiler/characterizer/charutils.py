...
def round_time(time,time_precision=3):
    """ times are in ns, so this is how many digits of precision: 3 digits=1ps, 4digits=0.1ps, etc.""" 
    
    return round(time, time_precision)

def round_voltage(voltage,voltag_precision=5):
    """ voltages are in volts: 3 digits=1mv, 4 digits=0.1mv, digits=0.01mv, 6 digits=1uv, etc """
