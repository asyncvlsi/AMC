...
class contact(design.design):
    """ Object for a contact shape with its conductor enclosures.
        ...
        only on two sides (and not four sides).
        The well/implant_type is an option to add a select/implant layer enclosing the contact. 
    ...
    def create_contact_array(self):
        ...
        self.via_layer_position =vector(max(self.first_layer_horizontal_enclosure,
    ...
    def create_first_layer_enclosure(self):
        ...
        self.first_layer_position = vector(max(self.second_layer_horizontal_enclosure - \
                                               self.first_layer_horizontal_enclosure,0),
                                           max(self.second_layer_vertical_enclosure - \
    ...
    def create_second_layer_enclosure(self):
        ...
        # this is if the first and second layers are different
        self.second_layer_position = vector(max(self.first_layer_horizontal_enclosure - \
